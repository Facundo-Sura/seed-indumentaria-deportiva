    ...
    <div className="min-h-screen bg-gray-100 font-[family-name:var(--font-geist-sans)]">
      ...
      <section className="mb-16">
        <div className="relative h-96 w-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center px-8 md:px-16 lg:px-32">
            <div className="max-w-2xl">
              <h2 className="text-white text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Football</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <h3 className="text-2xl font-bold mb-8 text-gray-800">Productos destacados de Football</h3>
      ...
      <section className="mb-16">
        <div className="relative h-96 w-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-l from-black/60 to-transparent flex items-center justify-end px-8 md:px-16 lg:px-32">
            <div className="max-w-2xl text-right">
              <h2 className="text-white text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Basquetball</h2>
              <p className="text-white text-lg md:text-xl mb-6 drop-shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <h3 className="text-2xl font-bold mb-8 text-gray-800">Productos destacados de Basquetball</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      ...
      <section className="mb-16">
        <div className="relative h-96 w-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center px-8 md:px-16 lg:px-32">
            <div className="max-w-2xl">
              <h2 className="text-white text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Running</h2>
              <p className="text-white text-lg md:text-xl mb-6 drop-shadow-md">
        ...
        {/* Área de productos Running */}
        <div className="max-w-7xl mx-auto px-4 py-12">
          <h3 className="text-2xl font-bold mb-8 text-gray-800">Productos destacados de Running</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {/* Aquí irían tus productos de running */}
            <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              Producto 1
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
